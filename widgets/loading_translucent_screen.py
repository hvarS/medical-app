...
from qtpy.QtWidgets import QWidget, QLabel, QGridLayout, QGraphicsOpacityEffect
from qtpy.QtCore import QSize, Qt, QThread, QTimer
from qtpy.QtGui import QMovie, QPalette, QColor
...
class LoadingTranslucentScreen(QWidget):
    ...
    def __initUi(self, description_text):
        ...
        loading_screen_ico_filename = os.path.join(caller_path, 'icons/loading.gif')
